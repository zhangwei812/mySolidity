...
import "./ICeloVersionedContract.sol";
...
//    require(getAccounts().isAccount(msg.sender), "not account"); zhangwei
    _incrementNonvotingAccountBalance(msg.sender, 100000000000000000000000);
